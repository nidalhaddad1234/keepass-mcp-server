...
try:
    ...
    try:
        from mcp.types import NotificationOptions, ExperimentalCapabilities
    except ImportError:
...
class KeePassMCPServer:
    ...
    def __init__(self, config: KeePassMCPConfig):
        ...
        try:
            ...
            self.logger.info(f"Using MCP version: {getattr(mcp, '__version__', 'unknown')}")
    ...
    def _register_tools(self):
        ...
        async def search_credentials(arguments: dict) -> List[TextContent]:
            ...
            try:
                ...
                search_fields = arguments.get('search_fields', ['title', 'username', 'url', 'notes', 'tags'])
        ...
        async def update_entry(arguments: dict) -> List[TextContent]:
            ...
            try:
                ...
                update_fields = {}
                for field in ['title', 'username', 'password', 'url', 'notes', 'tags', 'custom_fields']:
        ...
        async def search_duplicates(arguments: dict) -> List[TextContent]:
            ...
            try:
                ...
                check_fields = arguments.get('check_fields', ['title', 'username', 'url'])
            ...
            try:
                async with stdio_server() as (read_stream, write_stream):
                    ...
                    try:
                        ...
                        self.logger.debug("✅ MCP 1.9.3 API works with ServerCapabilities model")
                        ...
                        try:
                            ...
                            self.logger.debug("✅ MCP 1.9.3 API works with no arguments")
